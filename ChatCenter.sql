...
USE ChatCenter;
CREATE TABLE chatcenter_info(id int,center_name varchar(100) not null,location varchar(255) not null,contact_number varchar(15) unique,
email_address varchar(100) unique,established_date date check (established_date > '2015-01-01'),max_capacity int check (max_capacity > 0),
number_of_emp int,average_response_time int,operational_hours varchar(50))
